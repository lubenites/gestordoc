...
const estilosArea: { [key in Area]: { icono: React.ReactElement; clases: string } } = {
    [Area.VENTAS]: {
        icono: (
    ...
    [Area.FACTURACION]: {
        ...
        clases: 'bg-pink-100 text-pink-800',
    },
    [Area.OPERACIONES]: {
        icono: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        clases: 'bg-slate-200 text-slate-800',
    },
    [Area.ADMIN]: {
        icono: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
const AreaBadge: React.FC<AreaBadgeProps> = ({ area }) => {
  const estilo = estilosArea[area];
